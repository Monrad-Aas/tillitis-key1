...
enum {
    ...
    TK1_MMIO_WATCHDOG_BASE    = TK1_MMIO_BASE | 0x01000000,
    ...
    TK1_MMIO_WATCHDOG_STATUS_READY_BIT = 0,
    TK1_MMIO_WATCHDOG_PRESCALER        = TK1_MMIO_WATCHDOG_BASE | 0x28,
    TK1_MMIO_WATCHDOG_WATCHDOG         = TK1_MMIO_WATCHDOG_BASE | 0x2c,
